...
def formatSelectionString(paramsDict):
    ...
    desc_frags = ["To detect down to an effect size of <b>"," at <b>","% power</b> (alpha = <b>","</b>) for your <b>","</b>, you will need at least:"]

    effect_size_string = "Minimum Detectable Effect Size"
    d_string = "d = "
    ...
    description_string = desc_frags[0] + d_string + paramsDict["user_effect"] +"</b>"+ desc_frags[1] + str(float(paramsDict["user_power"])*100) + desc_frags[2] + paramsDict["user_alpha"] + desc_frags[3]+ paramsDict["Tindependece"]+ test_frag + balance_frag + tails_frag+desc_frags[4]

    display_text = {"selection_string":selection_string, "description_string":description_string, "effect_size_string": effect_size_string}
